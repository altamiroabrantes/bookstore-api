...
public class DBService {
	...
	public void instanciaBaseDeDados() {
		...
		Livro livro3 = new Livro(null, "The Time Machine", "H.G. Wells", "Lorem ipsu,", cat1);
		Livro livro4 = new Livro(null, "The War of the Worlds", "H.G. Wells", "Lorem ipsu,", cat1);
		Livro livro5 = new Livro(null, "I, Robot", "Isaac Asimov", "Lorem ipsu,", cat1);
